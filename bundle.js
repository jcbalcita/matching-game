...
/***/ function(module, exports, __webpack_require__) {
	...
	var _matching_game = __webpack_require__(160);

	var MatchingGame = _interopRequireWildcard(_matching_game);
	...
	var Game = function (_React$Component) {
	  ...
	  function Game(props) {
	    ...
	    var board = new MatchingGame.Board();
	    _this.state = {
	      board: board,
	      shownCard: null,
	      score: 0,
	  ...
	  _createClass(Game, [{
	    key: 'checkCard',
	    value: function checkCard(pos) {
	      var _this2 = this;

	      var board = this.state.board;
	      var card = board.cards[pos];
	      card.revealed = true;

	      this.setState({ board: board }, function () {
	        if (_this2.state.turn === 0) {
	          _this2.setState({
	            board: board,
	            turn: 1,
	            shownCard: card
	          });
	        } else if (_this2.state.turn === 1) {
	          _this2.checkIfMatch(pos);
	        }
	      });
	    }
	  }, {
	    key: 'checkIfMatch',
	    value: function checkIfMatch(pos) {
	      var _this3 = this;

	      var currentCard = this.state.board.cards[pos];
	      var prevCard = this.state.shownCard;
	      var board = this.state.board;
	    ...
	    value: function render() {
	      ...
	      var cards = this.state.board.cards.map(function (card, idx) {
	        return _react2.default.createElement(_card2.default, { card: card, key: idx, freeze: _this4.state.freeze, checkCard: _this4.checkCard });
	      });
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          { onClick: function onClick() {
	              return _this4.setState({ score: 26 });
	            } },
	          'Skip to end'
	        ),
	        _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Card = function (_React$Component) {
	  ...
	  _createClass(Card, [{
	    ...
	    value: function render() {
	      var card = this.props.card;
	      var suit = "assets/" + card.suit + ".png";
	      var color = card.suit === "spades" || card.suit === "clubs" ? "black" : "red";
	      ...
	      if (!card.revealed && !card.matched) {
	        return _react2.default.createElement(
	          "li",
	          { className: "card hidden", onClick: this.handleClick },
	          _react2.default.createElement("img", { src: "assets/card_back.jpg" })
	        );
	      } else {
	        return _react2.default.createElement(
	          "li",
	          { className: klass() },
	          _react2.default.createElement("img", { src: suit, className: "suit-image" }),
	          _react2.default.createElement("br", null),
	          _react2.default.createElement(
	            "p",
	            { className: color },
...
/***/ function(module, exports) {
	...
	var Card = exports.Card = function Card(value, suit) {
	  ...
	  _createClass(Board, [{
	    ...
	    value: function shuffleCards() {
	      for (var i = this.cards.length; i; i--) {
	        ...
	        var _ref = [this.cards[j], this.cards[i - 1]];
